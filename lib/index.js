...
program.version('1.0.2', '-v, --version').command('init <name>').action(function (name) {
    if (!fs.existsSync(name)) {
        inquirer.prompt([{
            ...
            spinner.start();
            var url = 'direct:http://gitlab.liebaopay.com:9090/CM_Launcher_FE_Work/scaffold.git#pc-spa';
